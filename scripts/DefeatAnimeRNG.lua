...
local QuestsTab = FarmingSection:Tab({
    Title = "Quests",
...
local InventoryTab = InvSection:Tab({
    Title = "Roll & Units",
    Icon = "solar:box-bold",
    IconShape = "Square",
    Border = true,
...
local RebirthSection = Window:Section({ Title = "Rebirth" })
local RebirthTab = RebirthSection:Tab({
    Title = "Prestige",
